...
/**
 * TestSourcesModel from Cucumber-JVM (MIT licensed)
 * Original source: https://github.com/cucumber/cucumber-jvm/blob/master/core/src/main/java/cucumber/runtime/formatter/TestSourcesModel.java
 * 
 */
